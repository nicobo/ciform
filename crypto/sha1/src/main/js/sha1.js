...
return {
    hex_sha:hex_sha1,
    b64_sha1:b64_sha1,
    str_sha1:any_sha1,  /* TODO check if it is used in ciform, then change its name */
    hex_hmac_sha1:hex_hmac_sha1,
    b64_hmac_sha1:b64_hmac_sha1,
    str_hmac_sha1:any_hmac_sha1  /* TODO check if it is used in ciform, then change its name */
};
